...
function About() {
  useEffect(() => {
    const typed = new Typed(".multiple", {
      strings: ["Java Developer", "Android Developer", "iOS Developer", "Angular Developer"],
      typeSpeed: 80,
      backSpeed: 60,
      backDelay: 1300,
      loop: true,
    ...
    <>
      <section id="about">
        <div className={AboutCss.about}>
          <div className={AboutCss.about_img} data-aos="fade-right" data-aos-delay="200">
            <img src={About_img} alt="" />
          </div>
          <div className={AboutCss.about_info} data-aos="fade-right" data-aos-delay="400" >
            <h2 data-aos="fade-right" data-aos-dely="600">About Me</h2 >
            <h3 data-aos="fade-right" data-aos-dely="800"> Abrar Ahamed</h3>
